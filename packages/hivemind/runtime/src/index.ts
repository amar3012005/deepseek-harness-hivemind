...
export function apply(ctx: Context, config: Config): void {
  ...
  ctx.skills.register({
    ...
    description: 'Load only for multi-source, temporal reconstruction, or conflict-reconciliation work. Simple profile, entity lookup, recall, and directory calls use hivemind_meta directly; stable single-fact saves use hivemind_save_memory.',
