...
export const zh = {
  ...
  'menu.fork': '分叉会话',
  'menu.shareSession': '分享会话',
  'menu.archiveSession': '归档会话',
  'delete.session': '永久删除会话',
  'dictation.start': '语音输入',
  'dictation.stop': '停止并转写',
  'dictation.cancel': '取消录音',
  'dictation.transcribing': '正在转写…',
...
export const en = {
  ...
  'menu.shareSession': 'Share session',
  'menu.archiveSession': 'Archive session',
  'delete.session': 'Delete session permanently',
  'dictation.start': 'Speak message',
  'dictation.stop': 'Stop and transcribe',
  'dictation.cancel': 'Cancel recording',
